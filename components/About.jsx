    ...
    <section id="about" className="py-20 px-6 md:px-20 bg-black relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, x: -30 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6, delay: 0.2 }} className="space-y-6">
          <div className="relative w-64 h-64 mx-auto lg:mx-0 rounded-2xl overflow-hidden border-2 border-red-500/30 shadow-[0_0_50px_rgba(220,38,38,0.2)] flex items-center justify-center bg-gradient-to-br from-red-600/20 to-black text-7xl">
            {/* Yahan bhi same photo daal sakta hai, warna emoji rakh */}
            👨‍💻
          </div>
